	...
	$(function (){
		PageLoader = {
		    ...
		    initGridPanel: function(){
		         var self = this;
		         var url = contextPath + '/auth/employeeUser/pagingQuery.do';
                        ...
                        $.get(contextPath + '/pages/auth/user-grantAuthorityToUser.jsp').done(function(data){
                            ...
                            dialog.find('.modal-header').find('.modal-title').html('为用户[' + userAccount + ']授权角色');
                                ...
                                dialog.find('#grantAuthorityToUserButton').on('click',function(){
                                    ...
                                    var url = contextPath+'/auth/employeeUser/grantAuthorityToActorInScope.do';
                            ...
                            dialog.find('#notGrantAuthorityToUserButton').on('click',function(){
                                ...
                                data = data.substring(0, data.length-1);
                                $.post(contextPath + '/auth/user/terminateAuthorizationByUserInRoles.do', data).done(function(data) {
                                    if(data.success){
                                        dialog.find('#grantAuthorityToUserMessage').message({
                                            type: 'success',
                                            content: '撤销用户的角色成功！'
                            ...
                            dialog.modal({
                                ...
                                'shown.bs.modal' : function(){
                                    ...
                                    dialog.find('#notGrantAuthoritiesToUserGrid').grid({
                                        ...
                                        url: contextPath + '/auth/user/pagingQueryNotGrantRoles.do?userId='+userId
                                    });

                                    dialog.find('#grantAuthoritiesToUserGrid').grid({
                                        identity: 'id',
                                        columns: hasGrantRoleColumns,
                                        url: contextPath + '/auth/employeeUser/pagingQueryGrantRoleByUserId.do?userId=' + userId
                                    });
                                }
                    ...
                    'grantPermissionToUser' : function(event, data){
                        ...
                        $.get(contextPath + '/pages/auth/user-grantAuthorityToUser.jsp').done(function(data){
                            ...
                            dialog.find('#notGrantAuthorityToUserButton').on('click',function(){
                                ...
                                data = data.substring(0, data.length-1);
                                $.post(contextPath + '/auth/user/terminatePermissionsByUser.do', data).done(function(data) {
                                    if(data.success){
                                        dialog.find('#grantAuthorityToUserMessage').message({
                                            type: 'error',
                                            content: '撤销用户的权限成功！'
                            ...
                            dialog.modal({
                                ...
                                'shown.bs.modal' : function(){
                                    ...
                                    dialog.find('#notGrantAuthoritiesToUserGrid').grid({
                                        ...
                                        url: contextPath + '/auth/user/pagingQueryNotGrantPermissions.do?userId='+userId
                                    });

                                    dialog.find('#grantAuthoritiesToUserGrid').grid({
                                        identity: 'id',
                                        columns: hasGrantPermissionColumns,
                                        url: contextPath + '/auth/employeeUser/pagingQueryGrantPermissionByUserId.do?userId='+userId
                                    });
                                }
        ...
        */
        ...
        var selectemployeeOrg = function (event, actorId, authorityId) {
            ...
            $.get( contextPath + '/pages/organisation/select-department-template.jsp').done(function(data){
                ...
                departmentTreeDialog.find('#confirm').on('click',function(){
                    ...
                    $.post(contextPath + '/auth/employeeUser/grantRolesToUserInScope.do', data, function (data) {
                        if(data.success){
        ...
        var loadDepartmentTree = function(departmentTree){
            ...
            $.get(contextPath + '/organization/org-tree.do').done(function(data){

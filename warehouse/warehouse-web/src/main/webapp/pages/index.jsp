...
<head>
    ...
    var contextPath = '${pageContext.request.contextPath}';
        $(function(){
            ...
            var url = contextPath + "/auth/currentUser/findAllMenusByUserAsRole.do?"+new Date().getTime();
            ...
            $('#userManager').find("li[data-target=#changeTelePhoneOfUser]").click(function(){
                $.get(contextPath + '/pages/auth/user-changeTelePhone.jsp').done(function(data){
                    ...
                    dialog.find('#changeTelePhoneOfUserSave').on('click', function(){
                        ...
                        $.post(contextPath+'/auth/currentUser/changeUserTelePhone.do',data,function(data){
                            if(data.success){
            ...
            $('#userManager').find("li[data-target=#changeEmailOfUser]").click(function(){
                $.get(contextPath + '/pages/auth/user-changeEmail.jsp').done(function(data){
                    ...
                    dialog.find('#changeEmailOfUserSave').on('click', function(){
                        ...
                        data['userPassword'] = confirmPassword.val();
                        $.post(contextPath+'/auth/currentUser/changeUserEmail.do',data,function(data){
                            if(data.success){
            ...
            $('#userManager').find("li[data-target=#rolesToggle]").click(function(){
                $.get(contextPath + '/pages/auth/role-switch.jsp').done(function(data){
                    ...
                    dialog.find('#toggle').on('click',function(){
                        ...
                        $.post(contextPath + '/auth/currentUser/switchOverRoleOfUser.do', "roleName=" + items[0].name,function(data){
                            if(data.success){
                                dialog.find('.selectRoleGrid').message({
                                    type:'success',
                                    content:'切换角色成功！'
                    ...
                    dialog.modal({
                        ...
                        'shown.bs.modal': function(){ //弹窗初始化完毕后，初始化url选择表格
                            ...
                            dialog.find('.selectRoleGrid').grid({
                                identity: 'id',
                                columns: columns,
                                url: contextPath + '/auth/currentUser/pagingQueryRolesOfUser.do'
                            });
                        }
...
<%-- 	        	<img src="${contextPath}/images/openci_icon.png" style="height:59px;width:94px;"/> --%>
	        	<span style="font-weight:800;">Warehouse System</span>
	        </a>
	        <div class="collapse navbar-collapse navbar-ex1-collapse" style="padding-right:50px;">
	...
	<div class="g-body">
	    ...
	    <div class="col-xs-10 g-mainc">
	        <ul class="nav nav-tabs" id="navTabs">
	            <li class="active"><a href="#home" data-toggle="tab">Homepage</a></li>
	        </ul>
    ...
    <%-- 底部 --%>
	<div id="footer" class="g-foot"><span>Copyright © 2014-2015</span></div>
</body>
</html>